...
const Courses = ({ courseId: propCourseId }) => {
  ...
  const handleEditGrade = async (e) => {
    e.preventDefault();
    if (selectedStudent && editingGrade && editingGrade.grade) {
      try {
        let gradeValue;
        // Always convert from AGH scale to percentage since that's what we're editing
                    ...
                    <tbody>
                      {studentGrades.map((grade, index) => (
                        <tr key={index}>
                          ...
                          <td>
                            {editingGrade && editingGrade.assignmentId === grade.AssignmentId ? (
                              <select
                            ...
                            {editingGrade && editingGrade.assignmentId === grade.AssignmentId ? (
                              ...
                              <button 
                                ...
                                onClick={() => setEditingGrade({
                                  ...
                                  grade: grade.AGH_Grade ? grade.AGH_Grade.toString() : '',
                                  gradeFormat: 'scale'
                                })}
                              >
                                Edit
